...
readEPICidats = function(sample.sheet,idat.dir,sample.col.name,preprocess=T){
...
saveRnBeadsObject = function(rnb.obj,path,archive = F){
  print("saving...\n")
  save.rnb.set(object = rnb.preprocessed$rnb.set,path = path,archive = archive)
}
